        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.collection.findOneAndReplace({ id: session.id }, session.toObject(), {
                                upsert: true,
                            })];
                    case 2:
                        _a.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        result = _a.sent();
                        return [2 /*return*/, result ? new shopify_api_1.Session(result) : undefined];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!rawResults || (rawResults === null || rawResults === void 0 ? void 0 : rawResults.length) === 0)
                            return [2 /*return*/, []];
                        return [2 /*return*/, rawResults.map(function (rawResult) { return new shopify_api_1.Session(rawResult); })];
                }
            });
        });
    };
